...
import (
	...
	"github.com/EduardoMontejo/bookstore_users-api/datasources/mysql/users_db"
	"github.com/EduardoMontejo/bookstore_users-api/logger"
...
func (user *User) Save() *errors.RestErr {
	...
	if err != nil {
		logger.Error("error when trying to get last_insert id after creating a new user", err)
		return errors.NewInternalServerError("database error")
	}
	user.Id = userId
	return nil
